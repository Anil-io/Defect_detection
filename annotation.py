...
source_folder = os.path.join(os.getcwd(), "SeatDefect\Ok\Images")
json_path = "Tesla\Ok\ok_json.json"      # Relative to root directory
count = 0                                           # Count of total images saved
file_bbs = {}                                       # Dictionary containing polygon coordinates for mask
MASK_WIDTH = 2448				    # Dimensions should match those of ground truth image
MASK_HEIGHT = 2048									
